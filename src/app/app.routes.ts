...
import { DefaultAPIComponent } from './html-editor/api/api.component';
...
import { IframeAPIComponent } from './iframe-editor/api/api.component';
...
import { MarkdownAPIComponent } from './markdown-editor/api/api.component';
...
export const rootRouterConfig: Routes = [
  ...
  { path: 'default-api', component: DefaultAPIComponent },
  ...
  { path: 'iframe-api', component: IframeAPIComponent },
  ...
  { path: 'md-api', component: MarkdownAPIComponent },
