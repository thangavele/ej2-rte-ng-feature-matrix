...
import { Button, DDL, MultiSelect, checkbox, generateWidget, CheckBoxOptions, singleProp, rowOptions, DDLOptions, InputOptions } from "./prop-util";
import {valType} from './prop-util'
...
export class composite {
    ...
    constructor(prop: object, rte: RichTextEditor) {
        this.prop = prop;
        this.rte = rte;
    }
    ...
    private submitAction(e: Event) {
        ...
        this.rte[parentType] = prop[parentType];
        this.rte.dataBind();
    }
    ...
    private renderSimpleProp(sub: object | string, key: string | object, element: HTMLElement) {
        ...
        let val =  this.rte[element.getAttribute('data-prop')][key as string];
